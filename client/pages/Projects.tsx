...
export default function Projects() {
  ...
  const projects = [
    // ✅ Added: Mission Defence Academy (Live)
    {
      name: 'Mission Defence Academy (MDA)',
      description:
        'Coaching institute website with courses, gallery, enquiry forms, and mobile-first UI. Built with Builder.io + React stack and deployed for production.',
      tech: ['React', 'Tailwind CSS', 'Builder.io', 'JavaScript'],
      liveUrl: 'https://mada.co.in/',
      featured: true,
      image: '/placeholder.svg',
    },
    // ✅ Added: TathaGat Tutorials (Live)
    {
      name: 'TathaGat Tutorials',
      description:
        'Education website for CAT & aptitude prep with sections for programs, testimonials, and contact. Clean, responsive design with fast load.',
      tech: ['React', 'Tailwind CSS', 'Builder.io', 'JavaScript'],
      liveUrl: 'https://tathagat.co.in/',
      featured: true,
      image: '/placeholder.svg',
    },

    {
      ...
      description:
        'A modern, responsive pharmaceutical company website built with React.js and powered by MongoDB Atlas. Features include product showcase, contact management, admin dashboard, and real-time inventory tracking.',
    ...
    },
    {
      name: 'JB Industries',
      description:
        'Modern industrial website showcasing company services and products with professional design and user-friendly interface.',
    ...
    },
    {
      ...
      description:
        'Professional consultancy website for job hiring and recruitment services. Features job postings, candidate management, and hiring solutions.',
              ...
              {projects
                ...
                .map((project, index) => (
                  <Card
                    ...
                    className="overflow-hidden hover:shadow-xl transition-all duration-300 border-primary/20 mb-8"
                  >
